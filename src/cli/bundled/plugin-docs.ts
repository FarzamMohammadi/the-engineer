...
type PRStatus = {
  ...
  draft: boolean;
  // Tri-state, like checks_state. "unknown" = the host has not finished computing mergeability (common
  // right after a push) — NOT a conflict; Core treats it as a wait, never rework.
