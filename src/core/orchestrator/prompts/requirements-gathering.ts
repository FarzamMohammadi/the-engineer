...
function buildRequirementsInstructions(ctx: RequirementsGatheringPromptContext): string {
  return section(
    ...
    [
      ...
      "",
      "Your default posture is: **I do not have enough context until proven otherwise.** You must be convinced — with evidence from the task description, acceptance criteria, or prior conversations — that you genuinely understand what to build, why, and how success is measured.",
      "",
      "**Code and documentation are context, not requirements.** Exploring the codebase tells you what exists, not what's wanted. Finding spec files, design docs, or READMEs in the repo does NOT confirm they are current, approved, or what the task owner actually wants. Documents can be outdated, aspirational, from a different iteration, or simply wrong. Never treat found documentation as confirmed requirements without explicit verification from the task owner.",
      "",
      "## Your Process",
      "",
