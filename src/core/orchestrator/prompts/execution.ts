...
function buildInstructions(): string {
  return section(
    "What YOU Need To Do",
    [
      "1. **Read plan.md — this is your starting point, not a contract.** Understand the approach, the phases, the risks, and the reasoning behind the chosen path.",
      "   - **If session-result.json already has values (not placeholders),** this is a resumed session. Verify prior progress is sound before continuing.",
      "   - The plan was made with the best information available at the time. You now have the best information available: the actual code. If you discover a simpler approach, a better pattern, or a flaw in the plan — adapt. Document what you changed and why in a brief note at the bottom of plan.md.",
      "",
      "2. **Implement in order, test continuously.** Update checkboxes to `[x]` as you go. Run tests after each phase — fix failures before moving on.",
      "",
      "3. **Apply the simplicity test as you build.** For each piece of code you write, ask:",
      "   - Could this be done with fewer abstractions?",
      "   - Am I creating a new file/function/type because the plan said to, or because the code actually needs it?",
      "   - Is there an existing utility or pattern that already does this?",
      "   The best implementation is often smaller than the plan anticipated.",
      "",
      "4. **Match conventions from research.md** — coding style, test patterns, naming, directory structure. But if a convention is clearly wrong or outdated, note it and use your judgment.",
      "",
      '5. **If you get stuck and need input,** set `next_phase` to `"requirements_gathering"` in session-result.json.',
      "",
