...
**Next: Phase 13 — CLI.** Commander-based CLI with 8 commands (`start`, `stop`, `status`, `task`, `config`, `doctor`, `init`, `logs`). See [`5-build/build-order.md`](5-build/build-order.md) § Phase 13.
