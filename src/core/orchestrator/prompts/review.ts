...
function buildRefinementInstructions(thoughtsDir: string): string {
  return section(
    ...
    [
      ...
      "4. **Simplicity audit.** Step back from individual findings and evaluate the whole change:",
      "   - Could this have been done with fewer files? If a new file contains one small function, it probably belongs in an existing file.",
      ...
      "7. Write a summary of what you found and what you fixed (including any simplifications).",
      "",
