...
function buildInstructions(directory: string): string {
  return section(
    ...
    [
      ...
      "",
      "4. If you must ask, write one outreach file per person you need, batching **all** of your questions for that person into that single file:",
      "",
      ...
      "",
      "5. Assess complexity honestly and record it in `details.complexity`:",
