...
**Next: Phase 11 — Orchestrator (Skeleton).** The brain of the system — a 7-phase pipeline that takes a task from intake to integration. See [`5-build/build-order.md`](5-build/build-order.md) § Phase 11.
