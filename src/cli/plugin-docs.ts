...
const TOOL_README = `# Tool Adapter
...
const TOOL_BASH_TOOL = `# Bash Shell Tool
...
export const ALL_PLUGIN_DOCS: PluginDoc[] = [
  ...
  { relativePath: "docs/plugins/tool/README.md", content: TOOL_README },
  { relativePath: "docs/plugins/tool/bash-tool.md", content: TOOL_BASH_TOOL },
];
