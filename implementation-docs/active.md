...
**Next: Phase 2 — Config Loader.** YAML multi-file config system (`~/.engineer/config/`), schema validation, hot-reload for safety/people configs. See [`5-build/build-order.md`](5-build/build-order.md) § Phase 2.
