...
**Next: Phase 4 — Event Bus.** Pub/sub + persistence to `events` table. Then Phase 5 (Adapter Base Classes), then Phase 6 (Registry), sequentially. See [`5-build/build-order.md`](5-build/build-order.md) § Phase 4.
