...
import type { EventDeclaration } from "../../../../src/core/event-bus/topology.js";
import { type DatabaseHandle, createInMemoryDatabase } from "../../../../src/db/database.js";
import { EventTypeSchema } from "../../../../src/schemas/events.js";
  ...
  describe("EventBus integration", () => {
    ...
    it("warns but publishes on invalid payload when NODE_ENV is not test", () => {
      ...
      try {
        ...
        expect(event.type).toBe("test.event");
        expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining("payload validation failed"), expect.any(Object));
      } finally {
