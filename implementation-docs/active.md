...
**Next: Phase 5 — Adapter Base Classes + SDK Boundary.** Abstract class hierarchy (BaseAdapter → 5 type-specific adapters), curated SDK boundary (`src/adapters/index.ts`). Then Phase 6 (Registry), sequentially. See [`5-build/build-order.md`](5-build/build-order.md) § Phase 5.
