...
- Acclimate to the project the way a real engineer joining it would, before any task-specific work — learn how it is structured, how it works, and the conventions its code already follows.
